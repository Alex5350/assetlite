...
/// <summary>
/// Strongly typed identifier for an <see cref="AssetLite.Domain.Assets.Assignment"/> child entity
/// of the <see cref="AssetLite.Domain.Assets.Asset"/> aggregate.
/// </summary>
/// <remarks>
...
public readonly record struct AssignmentId(Guid Value)
{
    ...
    /// <returns>A new, unique <see cref="AssignmentId"/>.</returns>
